                    ...
                    for j in range(len(figure_positions)):
                        ...
                        for point2 in figure_positions[j]:
                            ...
                            if sqrt((x2-x1)**2+(y2-y1)**2) < MIN_WIN_DIST:
                                win = False
            if win:
                win_font = pygame.font.Font('MenuFont.ttf', 40)
                win_text = win_font.render('YOU WIN !!!', 1, TANGO)
                screen.blit(win_text, (460, 200))
...
def help_menu():
    running_help = True
    back_to_menu_button = Button(100, 600, 300, 100, text='Back to Menu')
    while running_help:
        screen.fill(BLACK)
...
def main_menu():
    ...
    help_button = Button(100, 300, 300, 100, text='Help')
    quit_button = Button(100, 500, 300, 100, text='Quit')
    while True:
